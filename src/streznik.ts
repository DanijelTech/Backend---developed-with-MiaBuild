...
const PRIVZETA_KONFIGURACIJA: KonfiguracijaStreznika = {
    vrata: 3000,
    gostitelj: '0.0.0.0',
    casOvitka: 30000,
} as const;
 ...
 * @test TEST-002
 */
function obdelajZahtevo(
    zahteva: IncomingMessage,
    odgovor: ServerResponse
): RezultatZahteve {
 ...
 * @test TEST-001
 */
export function zazeniStreznik(
    konfiguracija: KonfiguracijaStreznika = PRIVZETA_KONFIGURACIJA
): Promise<void> {
